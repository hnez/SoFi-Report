...
\begin{subchapter}{Basic direction estimation}
  ...
  where there the locations of active transmitters
  ...
  and $A$ is a real valued scaling factor.
  ...
  is the phase difference between receiver 1 and 2:
  ...
  vectors are parallel (at $\theta_\text{max}$) and a minimum
...
\begin{subchapter}{Common noise}
  ...
  studying MIMO-systems, is that reciever noises are
  uncorrelated. \\
  ...
  \begin{description}
    ...
    \item[Baseband noise]
      ...
      lines on the receiver PCB due to insufficient shielding.
  ...
  calculated and compensated by filtering out the signal and finding the
